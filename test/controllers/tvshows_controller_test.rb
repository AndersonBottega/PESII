...
class TvshowsControllerTest < ActionController::TestCase
  ...
  test "should create tvshow" do
    assert_difference('Tvshow.count') do
      post :create, tvshow: { ano: @tvshow.ano, episodio: @tvshow.episodio, nota: @tvshow.nota, season: @tvshow.season, titulo: @tvshow.titulo }
    end
  ...
  test "should update tvshow" do
    patch :update, id: @tvshow, tvshow: { ano: @tvshow.ano, episodio: @tvshow.episodio, nota: @tvshow.nota, season: @tvshow.season, titulo: @tvshow.titulo }
    assert_redirected_to tvshow_path(assigns(:tvshow))
  end
